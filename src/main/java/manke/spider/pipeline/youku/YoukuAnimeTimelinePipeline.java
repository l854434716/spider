 ...
 * 处理将要更新的番剧数据
 */
public class YoukuAnimeTimelinePipeline extends AbstractMongodbPipeline implements Pipeline {
    private  static Logger logger= LoggerFactory.getLogger(YoukuAnimeTimelinePipeline.class);
