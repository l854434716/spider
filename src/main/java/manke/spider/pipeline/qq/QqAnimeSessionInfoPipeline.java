 ...
 */
public class QqAnimeSessionInfoPipeline extends AbstractMongodbPipeline implements Pipeline {

    private  static Logger logger= LoggerFactory.getLogger(QqAnimeSessionInfoPipeline.class);
    ...
    public void process(ResultItems resultItems, Task task) {
        ...
        Map<String,String>   season_info_kv=resultItems.get(QqAnimeSessionInfoPipeline.season_info_kv);
